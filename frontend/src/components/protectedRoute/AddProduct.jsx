  ...
  return (
    <div className=' p-2'>
      ...
      <div className='grid grid-cols-3 gap-x-16 p-8'>
        <img className='w-full h-[90%] object-cover' alt='preview image' src={Previmg ? Previmg : DefaultImage} />
        <form className='col-span-2 mt-4 grid grid-cols-2 gap-x-10 gap-y-3'>
          <div className='mb-4 flex gap-6 items-center'>
            <label className='text-gray-700 font-semibold flex items-center gap-5 ' htmlFor='file'>
      ...
      {success && <span className='text-green-500 mt-4 '>Created successfully...</span>}
    </div>
  );
};
